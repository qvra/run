...
Related routes:
- [`bench`](https://github.com/qvra/bench) for constrained comparison and measurement
- [`lab`](https://github.com/qvra/lab) for unstable experiments before promotion
- [`show`](https://github.com/qvra/show) for demos and visible proof
- [`pulse`](https://github.com/qvra/pulse) for visible motion and release rhythm
